...
多数のコミュニティ運営実績に裏付けられた、事業の担い手とファンを繋ぐD2Cの構築と専門家調達にも定評がある

Elixir（分散・並行・並列）とVR／AR、Web3／DID、エッジコンピューティング等の先端、Web／モバイル開発と、技術はオールラウンド

通信／金融・証券／小売／教育（e-learning）の業界知識も豊富に持ち、マーケティングやセールスの構想／実践も多くの実績を持つ
...
- 北九州マーケティングDX道場（YouTubeオンラインセミナー）
  - 2021年09月15日：講演 「イチから学ぶ『DX概論』」
- FM KITAQ（ラジオ）
